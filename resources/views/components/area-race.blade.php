...
@php
    ...
    $option = \WireCharts\Support\Option::areaRace([
        'series' => $series,
    ...
    $licensed = app(\WireCharts\Licensing\License::class)->allows('area-race');
@endphp

@unless ($licensed)
    <x-chart::_locked component="area-race" :height="$height" {{ $attributes }} />
@else
    <div
